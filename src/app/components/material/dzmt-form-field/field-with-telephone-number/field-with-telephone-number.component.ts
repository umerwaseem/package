...
@Component({
  selector: 'app-field-with-telephone-number',
  templateUrl: './field-with-telephone-number.component.html',
  styleUrl: './field-with-telephone-number.component.css',
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
...
export class FieldWithTelephoneNumberComponent {

...
@Component({
  selector: 'app-tree-with-partially-loaded-data',
  providers: [LoadmoreDatabase],
  standalone: true,
  imports: [MatTreeModule, MatButtonModule, MatIconModule],
  templateUrl: './tree-with-partially-loaded-data.component.html',
  styleUrl: './tree-with-partially-loaded-data.component.css'
})
export class TreeWithPartiallyLoadedDataComponent {

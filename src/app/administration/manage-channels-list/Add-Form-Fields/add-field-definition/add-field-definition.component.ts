...
export class AddFieldDefinitionComponent {
  ...
  randomString: any
  displayedColumns: string[] = ['fieldSequence', 'fieldName', 'internalTagName', 'fieldDescription', 'actions']
  ...
  addFieldDefinition() {
    if (this.fieldDefinitionForm.get('fieldDefinitionDetails')?.valid) {
      ...
      if (this.editFieldIndex !== null) {
        ...
        this.fieldDefinitionList = [...this.fieldDefinitionList, fieldDefinitionDetails];
